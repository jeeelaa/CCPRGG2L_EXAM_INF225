...
public class Regex {
	    ...
	    public static void main(String[] args) {
	        ...
	        pattern = Pattern.compile("^([vjrVJR])(1234567890).{5,}$");
	        ...
	        pattern = Pattern.compile("^[a-zA-Z0-9_.]*93[a-zA-Z0-9_.]*.{15,}@ymail.com$");
	        ...
	        pattern = Pattern.compile("^(http://|https://)?(www\\.)?anjielavejar\\.([a-z]+)(\\.[a-z]+)*/?$");
